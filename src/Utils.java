 ...
 * Only one instance of the Utils class should be created.
...
public class Utils {
    ...
    /**
     * A value indicating whether {@link Utils} instances should consume test values rather than prompting the user for input or querying a random number generator.
     */
    ...
    /**
     * The random number generator for the {@link Utils} instance.
     */
    private Random rand = new Random();

    /**
     * Sets the testing data to be used by all {@link Utils} instances.
     * The values will be consumed by Utils instances instead of prompting the user for input or querying a random number generator.
    ...
    public static void setTestingData(Integer[] randomValues, String[] inputValues) {
        testing = true;
        Utils.randomTestValues = new ArrayDeque<Integer>(Arrays.asList(randomValues));
        Utils.inputTestValues = new ArrayDeque<String>(Arrays.asList(inputValues));
    }
    ...
    public Integer getRandomInteger(Integer max) {
        ...
        if (Utils.testing) {
            Integer number = Utils.randomTestValues.poll();
    ...
    private String readStringInternal() {
        if (Utils.testing) {
            String testInput = Utils.inputTestValues.poll();
